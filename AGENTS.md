...
11. The Web client wraps an exact rc.6 conversation seam because no public atomic pre-submit middleware exists. Any DSH upgrade must re-audit both the conversation and connection/model-info seams, update the README compatibility statement, and exercise a real packed Web boot.
